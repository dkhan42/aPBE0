...
# Text files containing predicted a value, aPBE0 energy, PBE0 energy, and mean absolute error (MAE) across all subsets from GMTKN55 reported in figure 3 are available in the `gmtkn55_data.tar.xz` file along with a 'readme.txt` description (TBD).
